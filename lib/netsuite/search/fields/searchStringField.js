 ...
 * @override
 */
SearchStringField.prototype.getXml = function() {
  var xml = '';
  xml += '<platformCommon:' + this.field;
  xml += ' operator="' + this.operator;
  xml += '" xsi:type="platformCore:SearchStringField"><platformCore:searchValue>' + this.searchValue + '</platformCore:searchValue>';
  xml += '</platformCommon:' + this.field + '>';
  return xml;
};
